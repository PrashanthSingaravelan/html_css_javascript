	...
	jQuery.extend( support, {
		...
		reliableTrDimensions function() {
			...
			if ( reliableTrDimensionsVal == null ) {
				...
				table.style.cssText = positionabsolute;left-11111px;
				tr.style.height = 1px;
...
jQuery.fx.speeds = {
 ...
 httpsweb.archive.orgweb20100324014747httpblindsignals.comindex.php200907jquery-delay
	...
	propHooks {
		tabIndex {
			get function( elem ) {
				 ...
				 httpsweb.archive.orgweb20141116233347httpfluidproject.orgblog20080109getting-setting-and-removing-tabindex-values-with-javascript
